                    ...
                    <div class="col-md-12 animate-box" v-for="i in type">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <ul class="nav nav-tabs text-center" role="tablist" style="">
                                    <li role="presentation" class="active" style="text-transform:uppercase;"><a>{{
                                        i.category }}</a></li>
                                </ul>
                                <!-- end -->
                            </div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="main">
                                <div class="row">
                                    <div class="col-md-6" v-for="item in starter"
                                        ...
                                        <ul class="menu-dish">
                                            <li>
                                                ...
                                                <div class="text">
                                                    ...
                                                    <h3>{{ item['name'] }}</h3>
                                                    <p class="cat" style="cursor:pointer"
                                                       v-on:click.prevent="addToCart(item)">Add To Cart</p>
                                                </div>
                                                <!-- end  -->
                                            </li>
                                        </ul>
                    ...
                    <div class="modal-body"
                        ...
                        <ul class="list pl0 mt0 measure center" style="padding:40px">
                            <li class="flex items-center lh-copy pa3 ph0-l bb b--black-10" v-for="item in cart">
                                ...
                                <div>
                                    <a class="f6 link blue hover-dark-gray">
                                        <button v-on:click="removeFromCart(item)" class="btn_add">-</button>
                                        {{ item.quantity }}
