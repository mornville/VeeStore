    ...
    <div class="">
        <div class="" style="font-family: 'Montserrat', sans-serif;">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12" v-for="i in type">
                        <br><br>
                      <h3 class="uk-text-center uk-text-uppercase" style="font-family: 'Montserrat', sans-serif;color:black;">{{ i.category }}</h3>
                        ...
                        <div class="uk-child-width-1-2@s uk-grid-match" uk-grid>
                            <div v-for="item in starter"  v-if="item['category']==i['category']">
                                <div class="uk-card uk-text-left uk-text-left uk-card-default uk-card-hover uk-card-small uk-card-body" style="color:black;border-radius:10px;">
                                 <a class="" href="#modal-sections" uk-toggle>
                                       <li  class="flex items-center lh-copy pa3 ph0-l ">
                                        <img class="uk-border-circle uk-margin-small-right" width="60"  height="40" :src="item.image" />

                                        <div class="pl3 flex-auto uk-text-left">
                                             <h3 class="uk-card-title"  style="font-size:1em;color:black">{{ item.name }} <br>
                                    ...
                                    <div id="modal-sections" uk-modal>
                                        <div class="uk-modal-dialog uk-margin-auto-vertical">
                                            ...
                                            <div class="uk-modal-header">
                                                <h2 class="uk-modal-title" style="font-family: 'Montserrat', sans-serif;;font-size:1.3em">{{ item.name }} (&#8377;{{ item.price }})</h2>
                                            </div>
                                            <div class="uk-modal-body uk-text-center">
                                                
                                                <p style="font-family: 'Montserrat', sans-serif;">
                                                    <img class="uk-border-circle uk-margin-small-right" width="100"  height="40" :src="item.image" />
                                                    <br><br>
                                                    {{ item.description }}
                                                </p>
                                            </div>
                                            <div class="uk-modal-footer uk-text-center">
                                                <a href="tel:" class="uk-button uk-button-primary"
                                                       v-on:click.prevent="addToCart(item)">Add To Cart</a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-12 animate-box text-center">
                        <p><a href="#" class="uk-button uk-button-primary" data-toggle="modal"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="exampleModalLongTitle" style="text-align:center !important">Cart({{
                            cart.length }})</h3>
                    ...
                    <div class="modal-body"
                        ...
                        <!-- If cart Not empty -->
                        <ul class="list pl0 mt0 measure center" style="padding-top:40px;padding-bottom:40px;">
                            <li class="flex items-center lh-copy pa3 ph0-l bb b--black-10" v-for="item in cart">
                                ...
                                <div>
                                    <a class="f6 link blue hover-dark-gray" style="color:black">
                                        <button v-on:click="removeFromCart(item)" class="uk-button uk-button-small uk-button-default">-</button>
                                        {{ item.quantity }}
                                        <button v-on:click="addToCart(item)" class="uk-button uk-button-small uk-button-default">+</button>
                                    </a>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="uk-button uk-button-small uk-button-secondary" data-dismiss="modal">BUY MORE?</button>
                        <button @click="checkout()" id="lulz" class="uk-button uk-button-small uk-button-default">CHECKOUT (&#8377;{{ sum }})</button>
